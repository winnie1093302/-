...
$SQL="SELECT * FROM bartending WHERE tid=29 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:蘭姆酒+蜂蜜+檸檬汁+氣泡水</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:喝起來清爽無負擔，口味單純天然</p>
            <img src="小故事/Canchánchara.png" style="width: 30%;" class="story">
            ...
            $SQL3="SELECT * FROM bartending WHERE tid=30";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="藍色夏威夷.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            ...
            <td width=50px;></td>
            <td><a href="藍色夏威夷.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
