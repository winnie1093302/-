...
$SQL="SELECT * FROM bartending WHERE tid=8 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:伏特加酒＋薑汁啤酒＋新鮮檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸中帶辣的沁涼口感</p>
            <img src="小故事/莫斯科騾子.png" style="width: 30%;" class="story">
