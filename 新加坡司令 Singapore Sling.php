...
$SQL="SELECT * FROM bartending WHERE tid=14 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:琴酒+希琳櫻桃酒+班尼狄克丁+君度橙酒+鳳梨汁+檸檬汁+紅石榴糖漿+安格氏苦精+蘇打水</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:適合女生的酸甜水果系調酒</p>
            <img src="小故事/新加坡司令.png" style="width: 30%;" class="story">
