...
$SQL="SELECT * FROM bartending WHERE tid=6";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:巧克力糖漿+削片巧克力+貝禮詩奶酒+巧克力利口酒+伏特加</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:偏甜的口味，加上奶酒的風味，女生的最愛</p>
            <img src="小故事/巧克力馬丁尼.png" style="width: 30%;" class="story">
            ...
            $SQL2="SELECT * FROM bartending WHERE tid=3";
            $SQL3="SELECT * FROM bartending WHERE tid=5";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="血腥瑪麗.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="鹹狗.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="螺絲起子.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="血腥瑪麗.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="鹹狗.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
