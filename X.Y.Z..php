...
$SQL="SELECT * FROM bartending WHERE tid=27 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:蘭姆酒+橙酒+檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酒感偏重喝起來較銳利</p>
            <img src="小故事/xyz.png" style="width: 30%;" class="story">
            ...
            $SQL2="SELECT * FROM bartending WHERE tid=30";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="藍色夏威夷.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
            ...
            <td width=50px;></td>
            <td><a href="藍色夏威夷.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
