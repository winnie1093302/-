...
$SQL="SELECT * FROM bartending WHERE tid=23";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:白蘭地+薑汁汽水+檸檬汁+檸檬皮</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:檸檬的酸搭配薑汁汽水獨特的風味</p>
            <img src="小故事/白蘭地巴克.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=19";
            $SQL2="SELECT * FROM bartending WHERE tid=21";
            $SQL3="SELECT * FROM bartending WHERE tid=24";
            ...
            <tr>
                <td><a href="側車.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="白蘭地亞歷山大.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="霹靂神探.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="側車.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="白蘭地亞歷山大.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="霹靂神探.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
