    ...
    <div class="container">
      ...
      <ul class="cart-links ">
        ...
        <div id="content">
            ...
            <h1><img src="購物車杯.png" style="width: 30px;height: 70px;" class="pic"><p class="ppp">歷史訂單</p></h1>
        <hr Width="80%" Color="#fff">
        <?php
        
        $link=@mysqli_connect('localhost','root','','夢夜');
        $SQL="SELECT * FROM cart_link c,member m Where m.name='$name' AND c.mid=m.mid AND c.state='3'";
        ...
        <table class="table table-sm "style="text-align:center; margin-top:100px; width: 1000px;"   cellpadding="20px">
                ...
                <tbody>
                    ...
                    <table style="margin-left: 100px;">
							<tr>
									<td><a href="購物車-追蹤訂單.php"><img src="fast-forward (1).png" style="width: 50px;height:50px;"></a></td><td width=1500></td><td><a href="購物車-購物清單.php"><img src="fast-forward.png" style="width: 50px;height:50px;"></a></td>
								</tr>
								<br>
								<tr>
									<td width=150 style="color: #000000;">追蹤訂單</td><td width=1500></td><td width=200 style="color: #000000;">購物訂單</td>
								</tr>
							</table>
