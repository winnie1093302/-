...
$SQL="SELECT * FROM bartending WHERE tid=1 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:伏特加＋柳橙汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:微酸、微甜的口感，非常容易入喉</p>
            <img src="小故事/螺絲起子.png" style="width: 30%;" class="story">
