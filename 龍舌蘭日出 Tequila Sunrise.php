...
$SQL="SELECT * FROM bartending WHERE tid=42 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:龍舌蘭+柳橙汁+紅石榴糖漿</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:甜且酒感不重</p>
            <img src="小故事/龍舌蘭日出.png" style="width: 30%;" class="story">
