...
$SQL="SELECT * FROM bartending WHERE tid=3 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:伏特加＋番茄汁＋檸檬汁+Tabasco</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:跟主流的雞尾酒大相逕庭，味道複雜</p>
            <img src="小故事/血腥瑪麗.png" style="width: 30%;" class="story">
