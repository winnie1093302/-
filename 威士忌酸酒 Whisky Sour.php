...
$SQL="SELECT * FROM bartending WHERE tid=36 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:波本威士忌+檸檬汁+糖漿</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸酸甜甜搭配威士忌的風味</p>
            <img src="小故事/威士忌酸酒.png" style="width: 30%;" class="story">
            ...
            $SQL2="SELECT * FROM bartending WHERE tid=34";
            $SQL3="SELECT * FROM bartending WHERE tid=37";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="曼哈頓.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="盤尼西林.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="古典雞尾酒.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="曼哈頓.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="盤尼西林.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
