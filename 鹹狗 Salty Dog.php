...
$SQL="SELECT * FROM bartending WHERE tid=5 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:伏特加＋葡萄柚汁＋鹽</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:一開始席捲而來是鹹味，當酒伴隨著進入嘴巴後，滿滿的香氣跟葡萄柚的甜會因為鹽巴的引導而擴散開來</p>
            <img src="小故事/鹹狗.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=1";
            $SQL2="SELECT * FROM bartending WHERE tid=2";
            $SQL3="SELECT * FROM bartending WHERE tid=4";
            ...
            <tr>
                <td><a href="螺絲起子.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="柯夢波丹.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="性感海灘.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="螺絲起子.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="柯夢波丹.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="性感海灘.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
