...
$SQL="SELECT * FROM bartending WHERE tid=19 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:白蘭地+橙酒+檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸甜又富有酒感</p>
            <img src="小故事/側車.png" style="width: 30%;" class="story">
