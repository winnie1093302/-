...
$SQL="SELECT * FROM bartending WHERE tid=11 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:琴酒+玫瑰牌檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:琴酒的清香，檸檬的酸甜</p>
            <img src="小故事/琴蕾.png" style="width: 30%;" class="story">
