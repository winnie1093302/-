...
$SQL="SELECT * FROM bartending WHERE tid=24 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:杏仁香甜酒+白蘭地</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:口感討喜滑順</p>
            <img src="小故事/霹靂神探.png" style="width: 30%;" class="story">
