...
$link=@mysqli_connect('localhost','root','','夢夜');
$mid=$_GET['id'];
$SQL="SELECT * FROM cart_link c,member m Where m.mid='$mid' AND c.mid=m.mid AND c.state='1' UNION  SELECT * FROM cart_link c,member m Where m.mid='$mid' AND c.mid=m.mid AND c.state='2' ";
$result=mysqli_query($link,$SQL);
?>
        ...
        <tbody style="background-color:#FDFAE7;">
			...
			?>
                            ...
                            <td><?php
                                                ...
                                                <td><a href="sent.php?id=<?php echo $row['tname'];?>"><img src="send.png" style="width: 20px; height: 20px;"></a></td>
                                
                                <td>
                                <a href="finish.php?id=<?php echo $row['tname'];?>"><img src="completed-task.png" style="width: 20px; height: 20px;"></a>
