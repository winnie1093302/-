  ...
  <div class="top-header">
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        $SQL="SELECT * FROM bartending WHERE bid=7 AND state=1";
        ...
        <tbody>
            ...
            <!-- <div class="basicwine"> -->
            <!-- <div class="檸檬風味酒">
            <a href="檸檬風味酒.php" style="text-decoration:none;"><img src="調酒/檸檬風味酒.png" style="width:200px;height:250px"/> </a>
            <h2><a href="檸檬風味酒.php">檸檬風味酒</a><br><span style="color:#F2F4F3;">$79</span></h2>
            </div>
            <div class="芒果風味酒">
            <a href="芒果風味酒.php" style="text-decoration:none;"><img src="調酒/芒果風味酒.png" style="width:200px;height:250px"/> </a>
            <h2><a href="芒果風味酒.php">芒果風味酒</a><br><span style="color:#F2F4F3;">$100</span></h2>
            </div>
            <div class="荔枝風味酒">
            <a href="荔枝風味酒.php" style="text-decoration:none;"><img src="調酒/荔枝風味酒.png" style="width:200px;height:250px"/> </a>
            <h2><a href="荔枝風味酒.php">荔枝風味酒</a><br><span style="color:#F2F4F3;">$99</span></h2>
            </div>
            <div class="白桃風味酒">
            <a href="白桃風味酒.php" style="text-decoration:none;"><img src="調酒/白桃風味酒.png" style="width:200px;height:250px"/> </a>
            <h2><a href="白桃風味酒.php">白桃風味酒</a><br><span style="color:#F2F4F3;">$79</span></h2>
            </div>
            <div class="葡萄柚風味酒">
            <a href="葡萄柚風味酒.php" style="text-decoration:none;"><img src="調酒/葡萄柚風味酒.png" style="width:200px;height:247px"/> </a>
            <h2><a href="葡萄柚風味酒.php">葡萄柚風味酒</a><br><span style="color:#F2F4F3;">$89</span></h2>
            </div> -->
            <!-- <div class="Chocolatemartini">
            <a href="蘭姆.php" style="text-decoration:none;"><img src="基底酒圖/蘭姆.png" style="width:200px;height:250px"/> </a>
            <h2><a href="蘭姆.php">巧克力馬丁尼<br>Chocolate martini</a><br>$100</h2>
            </div>
            <div class="Kamikaze">
