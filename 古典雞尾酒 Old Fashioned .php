...
$SQL="SELECT * FROM bartending WHERE tid=33";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:裸麥威士忌+方糖+苦精</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:充滿麥芽香氣，苦精、方糖風味融合</p>
            <img src="小故事/古典雞尾酒.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=35";
            ...
            <tr>
                <td><a href="高球.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
            ...
            <tr>
            <td><a href="高球.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
