...
$SQL="SELECT * FROM bartending WHERE tid=25 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:白蘭姆酒+檸檬汁+糖漿+薄荷葉+蘇打水</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸酸甜甜的口感</p>
            <img src="小故事/莫希多.png" style="width: 30%;" class="story">
