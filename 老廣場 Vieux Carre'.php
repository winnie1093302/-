...
$SQL="SELECT * FROM bartending WHERE tid=20";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:威士忌+白蘭地+紅色苦艾酒+班尼迪克汀+安格仕苦精+裴喬苦精</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:味道甜但酒感重</p>
            <img src="小故事/老廣場.png" style="width: 30%;" class="story">
