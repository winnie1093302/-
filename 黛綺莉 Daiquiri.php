...
$SQL="SELECT * FROM bartending WHERE tid=26 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:蘭姆酒+糖漿+檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:微酸甜但酒勁強烈</p>
            <img src="小故事/黛綺麗.png" style="width: 30%;" class="story">
