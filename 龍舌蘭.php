  ...
  <div class="top-header">
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        $SQL="SELECT * FROM bartending WHERE bid=6 AND state=1";
        ...
        <tbody>
            ...
            <!-- <div class="basicwine"> -->
            <!-- <div class="Diablo">
            <a href="迪亞布羅.php" style="text-decoration:none;"><img src="調酒/迪亞布羅.png" style="width:200px;height:250px"/> </a>
            <h2><a href="迪亞布羅.php">迪亞布羅<br>Diablo</a><br><span style="color:#F2F4F3;">$150</span></h2>
            </div>
            <div class="Matador">
            <a href="鬥牛士.php" style="text-decoration:none;"><img src="調酒/鬥牛士.png" style="width:200px;height:250px"/> </a>
            <h2><a href="鬥牛士.php">鬥牛士<br>Matador</a><br><span style="color:#F2F4F3;">$110</span></h2>
            </div>
            <div class="Ice-Breaker">
            <a href="破冰船.php" style="text-decoration:none;"><img src="調酒/破冰船.png" style="width:200px;height:250px"/> </a>
            <h2><a href="破冰船.php">破冰船<br>Ice-Breaker</a><br><span style="color:#F2F4F3;">$150</span></h2>
            </div>
            <div class="TequilaSunrise">
            <a href="龍舌蘭日出.php" style="text-decoration:none;"><img src="調酒/龍舌蘭日出.png" style="width:200px;height:250px"/> </a>
            <h2><a href="龍舌蘭日出.php">龍舌蘭日出<br>Tequila Sunrise</a><br><span style="color:#F2F4F3;">$130</span></h2>
            </div>
            <div class="Margarita">
            <a href="瑪格麗特.php" style="text-decoration:none;"><img src="調酒/瑪格麗特.png" style="width:200px;height:250px"/> </a>
            <h2><a href="瑪格麗特.php">瑪格麗特<br>Margarita</a><br><span style="color:#F2F4F3;">$110</span></h2>
            </div>
            <div class="Rosita">
            <a href="蘿西塔.php" style="text-decoration:none;"><img src="調酒/蘿西塔.png" style="width:200px;height:250px"/> </a>
            <h2><a href="蘿西塔.php">蘿西塔<br>Rosita</a><br><span style="color:#F2F4F3;">$120</span></h2>
            </div>
