    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:白蘭地+可可利口酒+鮮奶油</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:富有奶味及甜味酒感較低</p>
            <img src="小故事/白蘭地亞歷山大.png" style="width: 30%;" class="story">
            ...
            $SQL2="SELECT * FROM bartending WHERE tid=22";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="床笫之間.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
            ...
            <td width=50px;></td>
            <td><a href="床笫之間.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
