...
$SQL="SELECT * FROM bartending WHERE tid=37 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:蘇格蘭淡泥煤威士忌+檸檬汁+蜂蜜水+薑汁糖漿</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:泥煤味、薑的辛辣、木質調的香氣、花香並結合了蜂蜜與檸檬的口感，層次明確且味道複雜</p>
            <img src="小故事/盤尼西林.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=33";
            $SQL2="SELECT * FROM bartending WHERE tid=36";
            $SQL3="SELECT * FROM bartending WHERE tid=38";
            ...
            <tr>
                <td><a href="古典雞尾酒.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="威士忌酸酒.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="國王谷.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="古典雞尾酒.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="威士忌酸酒.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="國王谷.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
