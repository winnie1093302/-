...
#content .Sidecar h2 a{
    color: #DBD0BE;
    text-decoration:none;
}
#content .Sidecar h2 a span{
    color: crimson;
}
.VieuxCarre
{
...
#content .VieuxCarre h2
{
    margin: 8px 0;
    line-height: 1.1;

}
#content .VieuxCarre h2 a{
    color: #DBD0BE;
    text-decoration:none;
}
.BrandyAlexander
  ...
  <div class="top-header">
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        $SQL="SELECT * FROM bartending WHERE bid=2 AND state=1";
        ...
        <tbody>
            ...
            <!-- <div class="Sidecar">
            <a href="側車.php" style="text-decoration:none;"><img src="調酒/側車.png" style="width:200px;height:250px"/> </a>
            <h2><a href="側車.php">側車<br>Sidecar</a><br><span style="color: #F2F4F3;">$110</span></h2>
            </div>
            <div class="VieuxCarre">
            <a href="老廣場.php" style="text-decoration:none;"><img src="調酒/老廣場.png" style="width:200px;height:250px"/> </a>
            <h2><a href="老廣場.php">老廣場<br>Vieux Carre'</a><br><span style="color:#F2F4F3;">$110</span></h2>
            </div>
            <div class="BrandyAlexander">
            <a href="白蘭地亞歷山大.php" style="text-decoration:none;"><img src="調酒/白蘭地亞歷山大.png" style="width:200px;height:250px"/> </a>
            <h2><a href="白蘭地亞歷山大.php">白蘭地亞歷山大<br>Brandy Alexander</a><br><span style="color:#F2F4F3;">$130</span></h2>
            </div>
            <div class="Betweenthesheets">
            <a href="床笫之間.php" style="text-decoration:none;"><img src="調酒/床笫之間.png" style="width:200px;height:250px"/> </a>
            <h2><a href="床笫之間.php">床笫之間<br>Between the sheets</a><br><span style="color:#F2F4F3;">$120</span></h2>
            </div>
            <div class="Brandybuck">
            <a href="白蘭地巴克.php" style="text-decoration:none;"><img src="調酒/白蘭地巴克.png" style="width:200px;height:250px"/> </a>
            <h2><a href="白蘭地巴克.php">白蘭地巴克<br>Brandy buck</a><br><span style="color:#F2F4F3;">$140</span></h2>
            </div>
            <div class="FrenchConnection">
            <a href="霹靂神探.php" style="text-decoration:none;"><img src="調酒/霹靂神探.png" style="width:200px;height:250px"/> </a>
            <h2><a href="霹靂神探.php">霹靂神探<br>French Connection</a><br><span style="color:#F2F4F3;">$180</span></h2>
            </div> -->
            <!-- <div class="Kamikaze">
            <a href="威士忌.php" style="text-decoration:none;"><img src="基底酒圖/威士忌.png" style="width:200px;height:250px"/> </a>
            <h2><a href="威士忌.php">神風特攻隊<br>Kamikaze </a><br>$100</h2>
            </div>
            <div class="MoscowMule">
            <a href="伏特加.php" style="text-decoration:none;"><img src="基底酒圖/伏特加.png" style="width:200px;height:250px"/> </a>
            <h2><a href="伏特加.php">莫斯科騾子Moscow Mule<br>Moscow Mule</a><br>$100</h2>
            </div>
            <div class="Good">
            <a href="琴酒.php" style="text-decoration:none;"><img src="基底酒圖/琴酒.png" style="width:200px;height:250px"/> </a>
