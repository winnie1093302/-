  ...
  <div class="top-header">
    <div class="container">
      ...
      <ul class="cart-links ">
        ...
        <li class="shopcart-dropdown"><a href="購物車-購物清單.php"><i class="fa fa-shopping-cart"></i> 購物車</li>
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            <!-- <div class="basicwine"> -->
            <div class="Whiskey">
            <a href="威士忌.php"><img src="基底酒圖/威士忌.png" style="width:200px;height:250px"/> </a>
            <h2><a href="威士忌.php" style="text-decoration:none;">威士忌 Whiskey</a></h2>
            </div>
            <div class="Vodka">
            <a href="伏特加.php"><img src="基底酒圖/伏特加.png" style="width:200px;height:250px"/> </a>
            <h2><a href="伏特加.php" style="text-decoration:none;">伏特加 Vodka</a></h2>
            </div>
            <div class="Gin">
            <a href="琴酒.php"><img src="基底酒圖/琴酒.png" style="width:200px;height:250px"/> </a>
            <h2><a href="琴酒.php" style="text-decoration:none;">琴酒 Gin</a></h2>
            </div>
            <div class="Tequila" >
            <a href="龍舌蘭.php"><img src="基底酒圖/龍舌蘭.png" style="width:200px;height:285px"/> </a>
            <h2><a href="龍舌蘭.php" style="text-decoration:none;">龍舌蘭 Tequila</a></h2>
            </div>
            <div class="Brandy">
            <a href="白蘭地.php"><img src="基底酒圖/白蘭地.png" style="width:200px;height:247px"/> </a>
            <h2><a href="白蘭地.php" style="text-decoration:none;">白蘭地 Brandy</a></h2>
            </div>
            <div class="Rum">
            <a href="蘭姆.php"><img src="基底酒圖/蘭姆.png" style="width:200px;height:250px"/> </a>
            <h2><a href="蘭姆.php" style="text-decoration:none;">蘭姆 Rum</a></h2>
            </div>
