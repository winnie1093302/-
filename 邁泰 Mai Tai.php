...
$SQL="SELECT * FROM bartending WHERE tid=31 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:白色蘭姆酒+白橙皮酒+檸檬汁+深色蘭姆酒+鳳梨汁+柳橙汁+紅石榴糖漿</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酒感重，味道卻香醇可口</p>
            <img src="小故事/邁泰.png" style="width: 30%;" class="story">
