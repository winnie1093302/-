...
$SQL="SELECT * FROM bartending WHERE tid=32 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:深色蘭姆酒+淺色蘭姆酒+檸檬汁+柳橙汁+百香果汁+糖漿+紅石榴糖漿</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:滿滿水果香但酒精含量還是很高</p>
            <img src="小故事/颶風.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=26";
            $SQL2="SELECT * FROM bartending WHERE tid=27";
            $SQL3="SELECT * FROM bartending WHERE tid=29";
            ...
            <tr>
                <td><a href="黛綺莉.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="X.Y.Z.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="Canchánchara.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="黛綺莉.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="X.Y.Z.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="Canchánchara.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
