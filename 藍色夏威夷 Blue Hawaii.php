...
$SQL="SELECT * FROM bartending WHERE tid=30 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:白色蘭姆酒+藍柑橘利口酒+鳳梨汁+椰奶+糖漿+鳳梨片+薄荷</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:香甜爽口，酸甜好滋</p>
            <img src="小故事/藍色夏威夷.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=25";
            ...
            <tr>
                <td><a href="莫希多.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
            ...
            <tr>
            <td><a href="莫希多.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
