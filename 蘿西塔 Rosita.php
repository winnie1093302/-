...
$SQL="SELECT * FROM bartending WHERE tid=44 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:龍舌蘭+甜苦艾酒+不甜苦艾酒+金巴利+苦精</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:x-large;">口感:重口味的調酒，苦中帶香</p>
            <img src="小故事/蘿西塔.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=39";
            $SQL2="SELECT * FROM bartending WHERE tid=40";
            $SQL3="SELECT * FROM bartending WHERE tid=41";
            ...
            <tr>
                <td><a href="迪亞布羅.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="鬥牛士.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="破冰船.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="迪亞布羅.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="鬥牛士.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="破冰船.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
