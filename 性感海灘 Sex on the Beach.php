...
$SQL="SELECT * FROM bartending WHERE tid=4 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:伏特加＋桃味烈酒＋橙汁＋蔓越莓汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸酸甜甜的少女酒</p>
            <img src="小故事/性感海灘.png" style="width: 30%;" class="story">
            ...
            $SQL3="SELECT * FROM bartending WHERE tid=3";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="血腥瑪麗.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            ...
            <td width=50px;></td>
            <td><a href="血腥瑪麗.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
