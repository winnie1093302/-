...
$SQL="SELECT * FROM bartending WHERE tid=46 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            $SQL2="SELECT * FROM bartending WHERE tid=47";
            $SQL3="SELECT * FROM bartending WHERE tid=49";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="芒果風味酒.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="白桃風味酒.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="檸檬風味酒.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="芒果風味酒.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="白桃風味酒.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
