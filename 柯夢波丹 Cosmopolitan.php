...
$SQL="SELECT * FROM bartending WHERE tid=2 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:伏特加＋君度橙酒＋現榨萊姆汁＋蔓越莓汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸甜微澀，能嚐到柑橘的清香，也能喝到蔓越莓的果香</p>
            <img src="小故事/柯夢波丹.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=3";
            $SQL2="SELECT * FROM bartending WHERE tid=4";
            $SQL3="SELECT * FROM bartending WHERE tid=7";
            ...
            <tr>
                <td><a href="血腥瑪麗.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="性感海灘.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="神風特攻隊.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="血腥瑪麗.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="性感海灘.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="神風特攻隊.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
