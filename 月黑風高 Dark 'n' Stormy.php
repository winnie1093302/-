...
$SQL="SELECT * FROM bartending WHERE tid=28";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:深色蘭姆酒+薑汁汽水+檸檬角</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸甜苦辣鹹都有</p>
            <img src="小故事/月黑風高.png" style="width: 30%;" class="story">
            ...
            $SQL3="SELECT * FROM bartending WHERE tid=32";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="藍色夏威夷.php"><?php echo "<img src='".$row2['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="颶風.php"><?php echo "<img src='".$row3['pic']." 'width=180px,height=375px'>";?></a></td>
            </tr>
            <tr>
            ...
            <td width=50px;></td>
            <td><a href="颶風.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
