...
$SQL="SELECT * FROM bartending WHERE tid=9 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:伏特加+杏仁利口酒</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:杏仁的特色明顯，卻又不失酒味</p>
            <img src="小故事/教母.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=2";
            ...
            <tr>
                <td><a href="柯夢波丹.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
            ...
            <tr>
            <td><a href="柯夢波丹.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
