...
$SQL="SELECT * FROM bartending WHERE tid=41 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:龍舌蘭+白橙皮酒+葡萄柚汁+紅石榴糖漿</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:沒有酒感像果汁，酸酸甜甜</p>
            <img src="小故事/破冰船.png" style="width: 30%;" class="story">
            ...
            $SQL3="SELECT * FROM bartending WHERE tid=44";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="蘿西塔.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            ...
            <td width=50px;></td>
            <td><a href="蘿西塔.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
