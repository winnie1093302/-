...
$SQL="SELECT * FROM bartending WHERE tid=45 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:琴酒+伏特加+龍舌蘭+蘭姆+白橙皮酒+檸檬汁+罐裝萊姆汁+柳橙汁+糖漿+可樂</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:x-large;">口感:有點甜，有點酸，有點苦，還有點辣</p>
            <img src="小故事/長島冰茶.png" style="width: 30%;" class="story">
