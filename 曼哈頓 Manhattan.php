...
$SQL="SELECT * FROM bartending WHERE tid=34 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:裸麥威士忌+甜苦艾酒+安格式苦精+櫻桃</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:裸麥威士忌散發特有香草氣味，加上些微果香與酸度</p>
            <img src="小故事/曼哈頓.png" style="width: 30%;" class="story">
