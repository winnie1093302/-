...
$SQL="SELECT * FROM bartending WHERE tid=40 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:龍舌蘭+鳳梨汁+檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:不甜但也不苦，柔順而有香氣</p>
            <img src="小故事/鬥牛士.png" style="width: 30%;" class="story">
            ...
            $SQL2="SELECT * FROM bartending WHERE tid=43";
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="瑪格麗特.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
            ...
            <td width=50px;></td>
            <td><a href="瑪格麗特.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
