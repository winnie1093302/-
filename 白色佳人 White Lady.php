...
$SQL="SELECT * FROM bartending WHERE tid=12";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:琴酒+橙酒+檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:順口柔順的口感 ，橙酒的柑橘香加上檸檬汁的清晰</p>
            <img src="小故事/白色佳人.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=11";
            ...
            <tr>
                <td><a href="琴蕾.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
            ...
            <tr>
            <td><a href="琴蕾.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
