...
$SQL="SELECT * FROM bartending WHERE tid=15 ";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:琴酒+伏特加+柳橙汁+紅石榴糖漿+艾碧斯苦艾酒</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:充滿果香以及草本的調酒</p>
            <img src="小故事/橫濱.png" style="width: 30%;" class="story">
