...
#content .Longislandicedtea h2 a{
    color: #DBD0BE;
    text-decoration:none;
}
#content .Longislandicedtea h2 a span{
    color: crimson;
}
.Cosmopolitan
{
  ...
  <div class="top-header">
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        $SQL="SELECT * FROM bartending WHERE bid=8 AND state=1";
        ...
        <tbody>
            ...
            <!-- <div class="basicwine"> -->
            <!-- <div class="Longislandicedtea">
            <a href="長島冰茶.php" style="text-decoration:none;"><img src="調酒/長島冰茶.jpg" style="width:200px;height:250px"/> </a>
            <h2><a href="長島冰茶.php">長島冰茶<br>Long island iced tea</a><br><span style="color:#F2F4F3;">$150</span></h2>
            </div> -->
            <!-- <div class="Cosmopolitan">
            <a href="伏特加.php" style="text-decoration:none;"><img src="基底酒圖/伏特加.png" style="width:200px;height:250px"/> </a>
            <h2><a href="伏特加.php">柯夢波丹<br>Cosmopolitan</a><br>$100</h2>
            </div>
            <div class="BloodyMary">
            <a href="琴酒.php" style="text-decoration:none;"><img src="基底酒圖/琴酒.png" style="width:200px;height:250px"/> </a>
            <h2><a href="琴酒.php">血腥瑪麗<br>Bloody Mary</a><br>$100</h2>
            </div>
            <div class="SexontheBeach">
            <a href="龍舌蘭.php" style="text-decoration:none;"><img src="基底酒圖/龍舌蘭.png" style="width:200px;height:285px"/> </a>
            <h2><a href="龍舌蘭.php">性感海灘<br>Sex on the Beach</a><br>$100</h2>
            </div>
            <div class="SaltyDog">
            <a href="白蘭地.php" style="text-decoration:none;"><img src="基底酒圖/白蘭地.png" style="width:200px;height:247px"/> </a>
            <h2><a href="白蘭地.php">鹹狗<br>Salty Dog</a><br>$100</h2>
            </div>
