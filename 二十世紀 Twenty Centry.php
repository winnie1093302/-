...
$SQL="SELECT * FROM bartending WHERE tid=16 ";
  ...
  <div class="top-header">
    <div class="container">
      ...
      <ul class="cart-links ">
          ...
          <li><a href="登入.php"><i class="fa fa-user"></i><span aria-hidden="true" class="icon_lock icon-fw"></span><?php echo $username;?></a></li>
        ...
        <div id="content">
            ...
            <!-- <img src="調酒/二十世紀 .png" style="width:300px;height:375px"/> -->

            </div>
            
            <p class="name"  style="font-size:xx-large; font-weight:bold;"><?php echo $name;?></p>

            <p class="mix"  style="font-size:large;">成分:琴酒+白麗葉酒+白巧克力酒+檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:淡淡的藥草味以及可可香，偏清爽而不是甜膩，偏向男性的口味</p>
            <img src="小故事/二十世紀.png" style="width: 30%;" class="story">
            ...
            <tr>
                ...
                <td width=50px;></td>
                <td><a href="白色佳人.php"><?php echo "<img src='".$row2['pic']." 'width=180px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="芙蘿拉朵拉.php"><?php echo "<img src='".$row3['pic']." 'width=200px,height=375px'>";?></a></td>
            </tr>
            <tr>
