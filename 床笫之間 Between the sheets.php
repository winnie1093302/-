...
$SQL="SELECT * FROM bartending WHERE tid=22";
    ...
    <div class="container">
      ...
      <!-- Button trigger modal -->
        ...
        <div id="content">
            ...
            <p class="mix"  style="font-size:large;">成分:白蘭地+白色蘭姆酒+橙酒+檸檬汁</p>
            <hr Width="40%" style="margin-left: 600px; margin-top:px">
            <p class="taste" Align="Left"  style="font-size:large;">口感:酸甜感，跟側車很像，酒感也偏重</p>
            <img src="小故事/床笫之間.png" style="width: 30%;" class="story">
            ...
            <?php
            $SQL1="SELECT * FROM bartending WHERE tid=20";
            $SQL2="SELECT * FROM bartending WHERE tid=24";
            $SQL3="SELECT * FROM bartending WHERE tid=23";
            ...
            <tr>
                <td><a href="老廣場.php"><?php echo "<img src='".$row1['pic']." 'width=180px,height=375px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="霹靂神探.php"><?php echo "<img src='".$row2['pic']." 'width=170px,height=355px'>";?></a></td>
                <td width=50px;></td>
                <td><a href="白蘭地巴克.php"><?php echo "<img src='".$row3['pic']." 'width=210px,height=375px'>";?></a></td>
            </tr>
            <tr>
            <td><a href="老廣場.php" style="text-decoration:none;" class="s1"><?php echo $row1['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="霹靂神探.php" style="text-decoration:none;" class="s1"><?php echo $row2['tname'];?></a></td>
            <td width=50px;></td>
            <td><a href="白蘭地巴克.php" style="text-decoration:none;" class="s1"><?php echo $row3['tname'];?></a></td>
